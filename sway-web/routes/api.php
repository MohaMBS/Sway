...
Route::group(['middleware' => 'auth:api'], function() {
    ...
    Route::put('loan/status',[LoanController::class, 'acceptLoan'])->name('passport.acceptLoan');//Obtener todos los prestamos del usuario;
    Route::get('loan/index',[LoanController::class, 'getLoan'])->name('passport.getLoan');//Obtener un prestamo;
